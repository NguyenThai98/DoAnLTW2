...
module.exports = {
    ...
    bvlienquan: function () {
        return db.load(`SELECT n.Avatar, n.NewsID,n.NewsTitle,n.DatePost,t.TagName FROM news n join tag t on n.TagID = t.TagID where  n.Status = 2  ORDER BY RAND() LIMIT 5 `);
    },
    ...
    ListCM: function () {
        return db.load(`SELECT DISTINCT  TagName FROM tag LIMIT 15`);
    },
